...
class Roll {
    /**
     * Create a new {@link Roll} based on two {@link Trait} instances.
    ...
    static traits(attribute, ability = null, {difficulty, threshold, specialty} = {}){
        ...
        return new Roll({pool, difficulty, threshold, specialty});
    }

    /**
     * Create a new roll and randomly generate a result.
     * @param {Roll|object} options - Parameters to use creating the roll.
     * @param {number} options.pool - See {@link Roll#pool}.
     * @param {number} [options.difficulty=6] - See {@link Roll#difficulty}.
     * @param {number} [options.threshold=0] - See {@link Roll#threshold}.
     * @param {boolean} [options.specialty=false] - See {@link Roll#specialty}.
